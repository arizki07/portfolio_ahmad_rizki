...
class ProjectList extends Controller
{
        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($data)
                ->addColumn('action', function ($row) {
                    $btn = '<div class="btn-list flex-nowrap">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                ...
                                <a href="#" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#modalDetailPermintaan" data-id="' . $row->id . '">
                                ...
                                <a href="#" class="dropdown-item edit-btn" data-bs-toggle="modal" data-bs-target="#modal-edit" data-id="' . $row->id . '">
                                ...
                                <a class="remove dropdown-item" href="javascript:void(0);" data-id="' . $row->nama . '" data-tgl="' . $row->tgl_project . '" data-desc="' . $row->keterangan . '">
                ...
                ->addColumn('status', function ($row) {
                    ...
                    return '<span class="status-dot status-dot-animated ' . $statusClass . '" style="font-size:11px"></span> <b class="' . $statusClass . '">' . $statusText . '</b>';
                })
    ...
    {
        DB::table('projects')->where('nama', '=', $id)->delete();
