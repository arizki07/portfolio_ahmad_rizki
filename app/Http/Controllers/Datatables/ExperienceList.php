...
class ExperienceList extends Controller
{
                ...
                ->addColumn('action', function ($row) {
                    $btn = '<div class="btn-list flex-nowrap">
                                ...
                                <div class="dropdown-menu dropdown-menu-end" style="">
                                    ...
                                    <a class="remove dropdown-item" href="javascript:void(0);" data-id="' . $row->jobs . '" data-nama="' . $row->periode . '" data-desc="' . $row->keterangan . '">
    ...
    {
        DB::table('experiences')->where('jobs', '=', $id)->delete();
